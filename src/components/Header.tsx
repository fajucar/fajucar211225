...
const Header: React.FC = () => {
  const { wallet, connectWallet, disconnectWallet, switchNetwork, isConnecting } = useArcWeb3();
  ...
  }, [wallet.chainId, normalizedChainId, isCorrectNetwork, isConnected]);
                    ...
                    <div className="px-4 py-3 border-b border-slate-700">
                      ...
                      {wallet.chainId && (
                        <p className="text-xs text-slate-400 mt-1">
                          Chain ID: {wallet.chainId} {wallet.chainId === ARC_TESTNET_CHAIN_ID ? '✓' : '✗'}
                        </p>
                      )}
                    </div>
                    {!isCorrectNetwork && (
