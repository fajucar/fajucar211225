  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Swap tokens on Arc Network. Coming soon - mini DEX with simple UX and stablecoin-first design." />
      </Helmet>
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 py-20">
          ...
          >
            ...
            <p className="text-base text-slate-400">
              This feature will enable seamless token swaps with USDC-based pairs, leveraging Arc Network's deterministic finality and stable fees.
            </p>
          </motion.div>
          ...
          >
            <div className="rounded-2xl border border-cyan-500/25 bg-slate-900/35 backdrop-blur-xl p-6">
              <h3 className="text-lg font-semibold text-cyan-400 mb-2">AMM Swap</h3>
              <p className="text-sm text-slate-400">
                Uniswap V2-style automated market maker for seamless token exchanges
              </p>
            </div>
            <div className="rounded-2xl border border-cyan-500/25 bg-slate-900/35 backdrop-blur-xl p-6">
              <h3 className="text-lg font-semibold text-cyan-400 mb-2">USDC-First</h3>
              <p className="text-sm text-slate-400">
                Native USDC pairs optimized for stablecoin trading on Arc Network
              </p>
            </div>
          </motion.div>
        </div>
